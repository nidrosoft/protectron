...
import { ProtectronLogo, ProtectronLogoMinimal } from "@/components/foundations/logo/protectron-logo";
        ...
        >
            ...
            >
                <div className="flex justify-center px-3">
                    <ProtectronLogoMinimal className="size-8" />
                </div>
                ...
                <div className="mt-auto flex flex-col gap-4 px-3 py-5">
                    ...
                    {/* Theme Toggle - Icon only for slim sidebar */}
                    <ThemeToggle size="sm" showLabel={false} className="justify-center" />
            ...
            <MobileNavigationHeader>
                <aside className="group flex h-full max-h-full w-full max-w-full flex-col justify-between overflow-y-auto bg-primary pt-4">
                    ...
                    <div className="mt-auto flex flex-col gap-5 px-2 py-4">
                        ...
                        <div className="flex items-center justify-between rounded-lg border border-secondary bg-secondary_subtle px-3 py-2.5">
                            <span className="text-sm font-medium text-secondary">Appearance</span>
