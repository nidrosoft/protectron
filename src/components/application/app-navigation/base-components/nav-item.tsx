...
const styles = sortCx({
    root: "group relative flex w-full cursor-pointer items-center gap-2 rounded-md bg-primary outline-focus-ring transition duration-100 ease-linear select-none hover:bg-primary_hover focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2",
    ...
    if (type === "collapsible-child") {
        return (
            <AriaLink
                ...
                className={cx("py-2.5 pr-3 pl-10", styles.root, current && styles.rootSelected)}
                onClick={onClick}
